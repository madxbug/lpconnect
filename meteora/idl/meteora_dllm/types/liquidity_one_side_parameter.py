...
class LiquidityOneSideParameterJSON(typing.TypedDict):
    amount: int
    active_id: int
...
@dataclass
class LiquidityOneSideParameter:
    ...
    @classmethod
    def from_decoded(cls, obj: Container) -> "LiquidityOneSideParameter":
        return cls(
            amount=obj.amount,
    ...
    def to_json(self) -> LiquidityOneSideParameterJSON:
        return {
            "amount": self.amount,
            "active_id": self.active_id,
            "max_active_bin_slippage": self.max_active_bin_slippage,
    ...
    @classmethod
    def from_json(
            cls, obj: LiquidityOneSideParameterJSON
