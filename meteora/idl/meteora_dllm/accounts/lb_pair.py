...
class LbPairJSON(typing.TypedDict):
    ...
    reserve_x: str
    reserve_y: str
    protocol_fee: meteora.idl.meteora_dllm.types.protocol_fee.ProtocolFeeJSON
    fee_owner: str
...
class LbPair:
    ...
    layout: typing.ClassVar = borsh.CStruct(
        ...
        "protocol_fee" / meteora.idl.meteora_dllm.types.protocol_fee.ProtocolFee.layout,
    ...
    reserve_x: Pubkey
    reserve_y: Pubkey
    protocol_fee: meteora.idl.meteora_dllm.types.protocol_fee.ProtocolFee
    fee_owner: Pubkey
    ...
    def decode(cls, data: bytes) -> "LbPair":
        ...
        return cls(
            ...
            protocol_fee=meteora.idl.meteora_dllm.types.protocol_fee.ProtocolFee.from_decoded(dec.protocol_fee),
    ...
    def from_json(cls, obj: LbPairJSON) -> "LbPair":
        return cls(
            ...
            protocol_fee=meteora.idl.meteora_dllm.types.protocol_fee.ProtocolFee.from_json(obj["protocol_fee"]),
