...
class AddLiquidityByWeightArgs(typing.TypedDict):
    liquidity_parameter: types.liquidity_parameter_by_weight.LiquidityParameterByWeight


layout = borsh.CStruct(
    "liquidity_parameter"
    / types.liquidity_parameter_by_weight.LiquidityParameterByWeight.layout
)


class AddLiquidityByWeightAccounts(typing.TypedDict):
    position: Pubkey
    lb_pair: Pubkey
...
def add_liquidity_by_weight(
    ...
    identifier = b"\x1c\x8c\xeec\xe7\xa2\x15\x95"
